...
const ChooseDatePage: FC = () => <div>This is the Date Page</div>;
const ChooseEmailPage: FC = () => <div>This is the Email Page</div>;

const flow = [ChooseTypePage, ChooseDatePage, ChooseEmailPage];
